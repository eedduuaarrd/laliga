 ...
 */
export const getGetPlayerPropsUrl = (matchId: number) => {
  return `/api/predictions/${matchId}/players`;
};
...
export const getPlayerProps = async (
  ...
  return customFetch<PlayerPropsResponse>(getGetPlayerPropsUrl(matchId), {
    ...options,
    method: "GET",
  });
};

export const getGetPlayerPropsQueryKey = (matchId: number) => {
  return [`/api/predictions/${matchId}/players`] as const;
};

export const getGetPlayerPropsQueryOptions = <
  TData = Awaited<ReturnType<typeof getPlayerProps>>,
  TError = ErrorType<unknown>,
>(
  matchId: number,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getPlayerProps>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetPlayerPropsQueryKey(matchId);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getPlayerProps>>> = ({
    signal,
  }) => getPlayerProps(matchId, { signal, ...requestOptions });
...
export type GetPlayerPropsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getPlayerProps>>
>;
export type GetPlayerPropsQueryError = ErrorType<unknown>;

/**
 * @summary Per-player prop predictions for a match (anytime scorer, assist, goal contribution)
 */

export function useGetPlayerProps<
  TData = Awaited<ReturnType<typeof getPlayerProps>>,
  TError = ErrorType<unknown>,
>(
  matchId: number,
  ...
  const queryOptions = getGetPlayerPropsQueryOptions(matchId, options);
 ...
 */
export const getGetProbableLineupsUrl = (matchId: number) => {
  return `/api/predictions/${matchId}/lineups`;
};

export const getProbableLineups = async (
  matchId: number,
  options?: RequestInit,
): Promise<ProbableLineupsResponse> => {
  return customFetch<ProbableLineupsResponse>(
    getGetProbableLineupsUrl(matchId),
    {
      ...options,
      method: "GET",
    },
...
export const getGetProbableLineupsQueryKey = (matchId: number) => {
  return [`/api/predictions/${matchId}/lineups`] as const;
};

export const getGetProbableLineupsQueryOptions = <
  TData = Awaited<ReturnType<typeof getProbableLineups>>,
  TError = ErrorType<unknown>,
>(
  matchId: number,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getProbableLineups>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetProbableLineupsQueryKey(matchId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getProbableLineups>>
  > = ({ signal }) =>
    getProbableLineups(matchId, { signal, ...requestOptions });
...
export type GetProbableLineupsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getProbableLineups>>
>;
export type GetProbableLineupsQueryError = ErrorType<unknown>;

/**
 * @summary Probable starting XI and bench for both sides
 */

export function useGetProbableLineups<
  TData = Awaited<ReturnType<typeof getProbableLineups>>,
  TError = ErrorType<unknown>,
>(
  matchId: number,
  ...
  const queryOptions = getGetProbableLineupsQueryOptions(matchId, options);
